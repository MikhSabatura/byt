...
public class Money implements Comparable {
    ...
    public String toString() {
        String result = String.valueOf(amount / 100); //getting integer part of the amount
        if (amount % 100 != 0) {
            result += "." + (amount % 100) / 10;  //getting tenth part of the amount
        }
        if (amount % 10 != 0) {
            result += amount % 10; //getting hundredth part of the amount
        }
